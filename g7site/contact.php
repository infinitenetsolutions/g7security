				...
				<div class="container">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li class="current"><a href="contact.php" class="external">CONTACT</a></li>
						</ul>
				...
				<div class="col-lg-5 col-md-5 col-sm-5">
					<div class="herotext overlay-margin">
						...
						<ul class="bullets-contact">
							<li><i class="fa fa-phone-square"></i> : 0800 123 4567</li>
							<li><a href="mailto:info@companyname.com"><i class="fa fa-envelope-square"></i> : info@g7security.com</a></li>
							<li><i class="fa fa-home"></i> : Jamshedpur - Jharkhand</li>
