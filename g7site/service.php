...
<head>
	...
	<body>
			...
			<div id="tc" class="container top-contact hidden-sm hidden-xs">
				<div class="row">
					<div class="col-lg-2 col-md-2">
						<!--  Logo Starts -->
						<a class="navbar-brand external" href="index.php"><img src="images/logos/logo-1.png" alt="" style="width:220px;"></a>
						<!-- Logo Ends -->
					</div> 
					<div class="col-lg-10 col-md-10">
						<ul class="small-nav">
							<li><i class="fa fa-phone-square"></i> 0800 123 4567</li>
							<li><a href=""><i class="fa fa-envelope-square"></i> info@g7security.com</a></li>
							<!-- <li class="shop">
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown current">
								...
								<ul class="dropdown-menu" role="menu">
									<li><a href="service.php" class="external">INDUSTRIAL SECURITY</a></li>
									<li><a href="service.php" class="external">RESIDENTIAL SECURITY</a></li>
									<li><a href="service.php" class="external">HOTEL SECURITY</a></li>
									<li><a href="service.php" class="external">CORPARATE SECURITY</a></li>
									<li><a href="service.php" class="external">INVESTIGATION SERVICE</a></li>
									<li><a href="service.php" class="external">TRAINING SERVICE</a></li>
									<li><a href="service.php" class="external">CLOSE PROTECTION</a></li>
									<li><a href="service.php" class="external">BANK SECURITY</a></li>
									<li><a href="service.php" class="external">SECURITY FOR ARCHAEOLOGICAL SITES</a></li>
									<li><a href="service.php" class="external">FIRE SQUAD</a></li>
									<li><a href="service.php" class="external">DOG SQUAD</a></li>
								</ul>
							</li>
							<li><a href="index.php" class="external">CLIENT</a></li>
							<li><a href="gallery.php" class="external">GALLERY</a></li>
							<li><a href="index.php" class="external">NEWS</a></li>
							<li><a href="index.php" class="external">CAREER</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-4">
						...
						<div class="description">Lorem ipsum dolor sit amet consectetur adipisicing elit sed dolora
							eiusmod tempor incididunt dolor magna aliqua ellut enim ad minim
							veniam quis nostrud exercitation ullamco aboris nisi aliquipue sed
							commod conseque aute irure dolor.
						</div>
					</div>
					<div class="col-lg-7 col-md-7 col-lg-offset-1 col-md-offset-1 picture">
						<img src="images/expertise/1.jpg" class="img-responsive" alt="">
					</div>
				</div>
			</div>
		</div>
		...
		<!-- SECURITY SOLUTIONS STARTS
			========================================================================= -->
		<div class="white-bg security-solutions">
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-offset-3 herotext">
						<h3>Providing security solutions that makes your life easier </h3>
						<h1>we deliver premium security solutions at best price</h1>
						<div class="line"></div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-lg-4 col-md-4">
						<div class="block">
							...
							<h1>CCTV System</h1>
							<div class="line2"></div>
							<div class="desciption">Enim ad min venia quis nostrud citation exa commodo consequat duis aut irue dolor reprehen derit in voluptate velit</div>
						</div>
					</div>
					<!-- Block Ends -->
					<!-- Block Starts -->
			...
			<div class="row no-gutter no-gutter-5 no-gutter-6">
				<div class="col-lg-5 col-md-5 col-sm-6">
					<div class="herotext overlay-margin">
						...
						<div class="text">-: We have highly trained staff available that implement security measures around any Retail, Commercial or Industrial Site.</div>
						<div class="line">&nbsp;</div>
						<div class="description">Lorem ipsum dolor sit amet consectetur adipisicing elit sed co eiusmod tempor incididunt dolore magna aliqua enim au minim veniam quis nostrud exercita.</div>
						<div class="button"><a href="#" class="btn-orange">Ask a Quote <i class="fa fa-chevron-right"></i></a></div>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-5 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 progress-01">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-7 col-md-7 herotext">
						...
						<div class="text">-: Join our team & start your career as a G7Security Officer. It’s our mission to	recruit the best as we always recruiting professionals, highly motivated & well presented Security Officers to join our team!</div>
						<div class="button"><a href="#" class="btn-orange">View the Jobs <i class="fa fa-chevron-right"></i></a></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-7 col-md-7 col-sm-7 col-lg-offset-1">
						<h1>Download tHE corporate brochure</h1>
						<h2>Ipsum sit amet consectetur adipisicing elit usmod tempor</h2>
					</div>
					<div class="col-lg-3 col-md-4 col-sm-4">
						<div class="button"><a href="download/Your-Brochure.pdf" target="_blank"><i class="fa fa-file-pdf-o"></i> Brouchure 2018</a></div>
					</div>
				</div>
			</div>
		</div>
