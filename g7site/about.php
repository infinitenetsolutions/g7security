				...
				<div class="container">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav">
							...
							<li class="current"><a href="about.php" class="external">ABOUT</a></li>
			...
			<div class="row no-gutter no-gutter-4">
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="block">
						...
						<div class="info">
							<div class="heading">Vision & Mission</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="block">
						...
						<div class="info">
							<div class="heading">Our Achievements</div>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 block">
						...
						<div class="details">
							...
							<div class="description">Lorem ipsum dolor sit amet consectetur adipisicing elit sed dol
								eiusmod tempor incididunt dolor magna aliqua ut enim minim
								veniam quis nostrud exercitation ullamco aboris nisi dualiquip 
								commod conseque aute irure.
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6 block">
			...
			<div class="history-timeline">
					...
					<div class="row">
						<div class="col-lg-10 col-lg-offset-1">
							<div class="herotext-3">
								...
								<div class="description">We offer some best security products in our shop adipisicing elit eiusmod tempor</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-10 col-lg-offset-1 history-timeline-tabs">
					...
					<ul class="nav nav-justified icon-tabs" role="tablist">
						...
						<li role="presentation">
							<a href="#2015" aria-controls="2015" role="tab" data-toggle="tab">								
		...
		<div class="container clients">
			<div class="row">
				<div class="col-lg-12 clients-carousel">
					<div class="block"><img src="images/clients/1.png" class="img-responsive center-block" alt=""></div>
					<div class="block"><img src="images/clients/2.png" class="img-responsive center-block" alt=""></div>
					<div class="block"><img src="images/clients/3.png" class="img-responsive center-block" alt=""></div>
					<div class="block"><img src="images/clients/4.png" class="img-responsive center-block" alt=""></div>
					<div class="block"><img src="images/clients/5.png" class="img-responsive center-block" alt=""></div>
					<div class="block"><img src="images/clients/2.png" class="img-responsive center-block" alt=""></div>
					<div class="block"><img src="images/clients/3.png" class="img-responsive center-block" alt=""></div>
				</div>
			</div>
