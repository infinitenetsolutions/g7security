...
$del_id = $checkbox[$i]; 
$result=mysqli_query($conn,"DELETE FROM emp_data WHERE id='".$i."'");
...
<div class="col-md-4">
  <?php 
  $query=mysqli_query($conn,"select * from emp_data"); // SQL Query
       ?> <ul>
...
<?php while($row = mysqli_fetch_assoc($query)) 
  {
    ...
    <li><input type="checkbox" class="group1" name="check[]"><?php echo $row['emp_name'];?> </li><?php } ?>
