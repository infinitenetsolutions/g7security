     ...
     if (isset($_POST['submit']))  
      {     
        // var_dump($_POST);exit();
          ...
          $query = mysqli_query($conn, "INSERT INTO `company` (`company_name`,`company_address`,`contact_per_name`,`contact_per_add`)VALUES ('" . $company_name . "','" . $company_address . "','" . $contact_per_name . "','" . $contact_per_add . "')");
