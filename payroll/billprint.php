...
<!DOCTYPE html>
    ...
    <head>
        ...
        <style type="text/css">
            .table-responsive,td,th{text-align: center;font-size: 15px;}
            address{font-size: 16px;}
            .top{margin-top: -42px;margin-left: 65px;}
            h4{text-align: center;}
            h5{text-align: center;}
            .beats{margin-left: 120px;}
        </style>
                                ...
                                <section class="content invoice">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 invoice-header">
                                            <center><img src="images/sun.jpg" style="width: 40px;height:40px;">
                                               <br><u>Tax Invoice</u></center>
                                            <h1>
                                                <img src="images/logo.png" style="width: 50px;height: 40px;">

                                                <h3 class="top">GSEVEN INDUSTRIAL SECURITY AGENCY PVT. LTD.</h3><h4>JAMSHEDPUR,HEAD OFFICE</h4><h5>H NO.477,Road No.-1,Tripurari Colony,Adityapur-1,Jamshedpur-831013</h5><h5>E_mail:g7security@gmail.com Phone no:9835196337,943134173</h5>
