		...
		<div class="container contents">
			<div class="row no-gutter-8 no-gutter no-gutter-4">
				<!-- RIGHT COLUMN STARTS
					========================================================================= -->
					<?php
					$news= mysqli_query($dbcon,"select * from news");
				...
				<div class="col-lg-12 col-md-12">
					...
					<div class="row blog-post no-gutter-5" id="gseven">
						<div class="col-lg-5 col-md-5 col-sm-5 post-picture">
							<img src="admin/news/<?php echo $news_result['file'] ?>" class="img-responsive" alt="">
						</div>
						<div class="col-lg-7 col-md-7 col-sm-7 post-contents">
							<div class="meta">-:Admin</div>
							<h1><?php echo $news_result['header']; ?></h1>
							<div class="description"><?php echo $news_result['details']; ?>
							</div>
							<!-- <div class="clearfix">
